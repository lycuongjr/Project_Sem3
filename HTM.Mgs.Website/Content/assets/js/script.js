...
//        '<a href="#" onclick="LoadAdd()" data-toggle="modal" data-target=".bd-example-modal-lg" class="btn btn-md btn-primary">' +
//            '<i class="fa fa-plus" aria-hidden="true"></i> Thêm mới sinh viên' +
//        '</a> ' +
//    '</div>' +
//'');
var $window = $(window);
